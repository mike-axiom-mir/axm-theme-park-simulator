# BUILD CHAT — F — Low-Graphic Animation Testing Ground

## Restore

`/returncore /soulcheck /game-agent /theme-park-sim /realistic-determinism /mergegate`

Build **F — Low-Graphic Animation Testing Ground** on top of:
...
- `manifests/animation_testing_ground.json`
...
- simple self-made movement/animation clips;
- ride, queue, crowd, weather, and interaction render adapters;
- visual debug overlays and upgrade ladder.

## Must consume, not silently redefine

Authoritative world, ride, visitor, crew, scenery, weather, and observation
state without changing the simulation.

## Required design behavior

Reach readable self-made low graphics first. Improve in explicit passes.
Keep low-spec modes viable and label concept art honestly.
