# BUILD CHAT — C — Decoration, Atmosphere, and Influence

## Restore

`/returncore /soulcheck /game-agent /theme-park-sim /realistic-determinism /mergegate`

Build **C — Decoration, Atmosphere, and Influence** on top of:
...
- `manifests/decoration_and_influence.json`
...
- scenery entities, theme zones, coherence, transitions, sightlines;
- clutter, contradiction, lighting, sound, landscaping, shade, comfort;
- queue/ride/land sensory integration;
- audience-specific atmosphere evidence.

## Must consume, not silently redefine

Ride layout/experience, visitor perception, crew maintenance, park identity,
weather/time, campaign context, shared evidence/explanation contracts.

## Required design behavior

Theming remains optional but meaningful. Influence comes from fit,
coherence, visibility, comfort, maintenance, and integration—not decoration
spam or object totals.
