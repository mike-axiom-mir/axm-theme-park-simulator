...
You are building **Rides and Attractions** as a domain module on top of:
...
- condition, reliability, comfort, intensity, accessibility interfaces;
...
- park identity and geography context;
- visitor demand/experience requests;
- scenery atmosphere evidence;
- crew service evidence;
