...
test("playable wiring routes staff development without expanding renderer authority", () => {
  ...
  const specialRenderer = read("../src/render/specialContentWorldRenderer.js");
